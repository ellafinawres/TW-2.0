...
class Author extends \App\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'username', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'books', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'nbrBooks'];
        }
     ...
     * {@inheritDoc}
     */
    public function addBook(\App\Entity\books $book): static
    {
     ...
     * {@inheritDoc}
     */
    public function removeBook(\App\Entity\books $book): static
    {
    ...
    public function getNbrBooks(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbrBooks', []);

        return parent::getNbrBooks();
    }
    ...
    public function setNbrBooks(int $nbrBooks): static
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrBooks', [$nbrBooks]);

        return parent::setNbrBooks($nbrBooks);
    }
